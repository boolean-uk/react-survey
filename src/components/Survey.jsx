              ...
              <ul>
                ...
                <li>
                  <input
                    ...
                    name="rubberDuck"
                    value="3"
                    checked={form.rubberDuck === '3'}
                    onChange={(event) => { handleChange(event) }} />
                  <label htmlFor="color-three">3</label>
                </li>
                <li>
                  <input id="color-four" type="radio" name="rubberDuck" value="4" checked={form.rubberDuck === '4'} onChange={(event) => handleChange(event)} />
                ...
                <li>
                  <label>
                    <input
                      ...
                      onChange={(event) => handleChange(event)} />Swimming</label>
                </li>
                <li>
                  <label>
                    <input 
                ...
                <li>
                  <label>
                    <input
                      ...
                      onChange={(event) => handleChange(event)} />Chatting</label>
                </li>
                <li>
                  <label>
                    <input name="spend-time" type="checkbox" value="noTime"
                      // checked={form.spendTime === 'noTime'} 
                      onChange={(event) => handleChange(event)} />I don't like to spend time with it</label>
                </li>
              </ul>
            </div>
